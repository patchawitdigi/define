                        ...
                        <Row>
                            <Col sm={2}>
                                <li className="infoetc">
                                    <label id="etc01"><h4>{t('SHOP')}</h4><p id="roll01">^</p></label>
                                    <ul id="etcblock">
                                        <li><a href="https://www.capitaland.com/en/shop/malls.html?category=retail" target="_blank">{t('Malls')}</a></li>
                                        <li><a href="https://www.capitaland.com/en.html" target="_blank">{t('Deals')}</a></li>
                                        <li><a href="https://www.capitaland.com/en/shop/rewards.html" target="_blank">{t('Rewards')}</a></li>
                                    </ul>
                                </li>
                            </Col>
                            <Col sm={2}>
                                <li className="infoetc" >
                                    <label id="etc02"><h4>{t('STAY')}</h4><p id="roll02">^</p></label>
                                    <ul id="etcblock">
                                        <li><a href="https://www.capitaland.com/en/stay/residential-developments.html?category=residential" target="_blank">{t('Residential Developments')}</a></li>
                                        <li><a href="https://www.capitaland.com/en/stay/lodging.html?category=lodging" target="_blank">{t('Lodging')}</a></li>
                                    </ul>
                                </li>
                            </Col>
                            <Col sm={3}>
                                <li className="infoetc">
                                    <label id="etc03"><h4>{t('LEASE')}</h4><p id="roll03">^</p></label>
                                    <ul id="etcblock">
                                        <li><a href="https://www.capitaland.com/en/lease/businessparks-industrial-logistics.html?category=businesspark-industrial-logistics" target="_blank">{t('Business Parks, Industrial & Logistics Spaces')}</a></li>
                                        <li><a href="https://www.capitaland.com/en/lease/offices.html?category=commercial" target="_blank">{t('Offices')}</a></li>
                                        <li><a href="https://www.capitaland.com/en/lease/malls.html?category=retail" target="_blank">{t('Malls')}</a></li>
                                    </ul>
                                </li>
                            </Col>
                            <Col sm={2}>
                                <li className="infoetc">
                                    <label id="etc04"><h4>{t('INVEST')}</h4><p id="roll04">^</p></label>
                                    <ul id="etcblock">
                            ...
                            <Col sm={3}>
                                <li className="infoetc mfcapi">
                                    <label id="etc05"><h4>{t('MORE FROM CAPITALAND')}</h4><p id="roll05">^</p></label>
                                    <ul id="etcblock">
                                        <li><a href="https://www.capitaland.com/en/about-capitaland/who-we-are.html" target="_blank">{t('Who We Are')}</a></li>
                                        <li><a href="https://www.capitaland.com/en/about-capitaland/sustainability/capitaland-hope-foundation/overview.html" target="_blank">{t('CapitaLand Hope Foundation')}</a></li>
                                        <li><a href="https://www.capitaland.com/en/about-capitaland/sustainability.html" target="_blank">{t('Sustainability')}</a></li>
                                        <li><a href="https://www.capitaland.com/en/about-capitaland/careers.html" target="_blank">{t('Careers')}</a></li>
                                        <li><a href="https://www.capitaland.com/en/art-at-capitaland.html" target="_blank">{t('Art @ CapitaLand')}</a></li>
                                        <li><a href="https://www.capitaland.com/en/about-capitaland/newsroom.html" target="_blank">{t('Newsroom')}</a></li>
                                        <li><a href="https://www.capitaland.com/en/inside-magazine.html" target="_blank">{t('Blog')}</a></li>
                                        <li><a href="https://www.capitaland.com/en/about-capitaland/awards.html" target="_blank">{t('Awards')}</a></li>
                                        <li><a href="https://www.capitaland.com/en/more-from-capitaland/social-media.html" target="_blank">{t('Follow @CapitaLand on social!')}</a></li>
                                        <li><a href="https://www.capitaland.com/api-portal/index.html" target="_blank">{t('API Portal')}</a></li>
                                    </ul>
                                </li>
                            </Col>
                        </Row>
                    ...
                    <Row>
                        ...
                        <Col sm={6}>
                            <div className="address">
                                <p>{t('Website Owner: CapitaLand-Thien Duc Company Limited')}
                                    <br />{t('Enterprise Registration Certificate No. 0309710742 issued by the Department of Planning and')}
                                    <br />{t('Investment Ho Chi Minh City, 1st issued on 30 December 2009')}
                                    <br />{t('Address: No 02, Phan Van Dang Street, Thanh My Loi Ward, Thu Duc City, Ho Chi Minh City')}
